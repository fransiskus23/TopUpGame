...
<script>
    ...
    root.style.setProperty('--base', '<?php echo e(config('basic.base_color')); ?>');
    root.style.setProperty('--base-secondary', '<?php echo e(config('basic.base_secondary')); ?>');
    root.style.setProperty('--base-rgba', '<?php echo e(hex2rgba(str_replace('#','',config('basic.base_color')), 0.6)); ?>');
</script>
<?php /**PATH C:\xampp\htdocs\gamersArena\project\resources\views/plugins.blade.php ENDPATH**/ ?>