                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Status')">
                                ...
                                <span class="badge badge-light">
                                    <i class="fa fa-circle text-success success  font-12"></i>  @lang('Approved')
                                </span>
                                @elseif($item->status == 1)
                                <span class="badge badge-light">
                                    <i class="fa fa-circle text-warning warning  font-12"></i>  @lang('Pending')
                                </span>
                                @elseif($item->status == 3)
                                 <span class="badge badge-light">
                                    <i class="fa fa-circle text-danger danger  font-12"></i>  @lang('Rejected')
                                </span>
                                @endif
                            </td>
