        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @if(config('basic.top_up'))
                    <li class="sidebar-item {{menuActive(['admin.category*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.category') }}" aria-expanded="false">
                            ...
                            <span class="hide-menu">@lang('Game Topup')</span>
                        </a>
                    </li>
                @endif

                @if(config('basic.voucher'))
                    <li class="sidebar-item {{menuActive(['admin.game_voucher*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.gameVoucher') }}" aria-expanded="false">
                ...
                @if(config('basic.gift_card'))
                    <li class="sidebar-item {{menuActive(['admin.giftCard'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.giftCard') }}" aria-expanded="false">

                            <i class="fab fa-cc-apple-pay"></i>
                            <span class="hide-menu">@lang('Gift Cards')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(config('basic.sell_post'))
                    ...
                    <li class="sidebar-item {{menuActive(['admin.sellPostCategory*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.sellPostCategory') }}" aria-expanded="false">
                            <i class="fas fa-bullhorn"></i>
                            <span class="hide-menu">@lang('Sell Category')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(config('basic.sell_post'))
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu">@lang('Sell Post')</span></li>
                    <li class="sidebar-item {{menuActive(['admin.template.show*'],3)}}">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fas fa-bullhorn"></i>
                            <span class="hide-menu">@lang('Selling Post')</span>
                        </a>
                        <ul aria-expanded="false"
                            class="collapse first-level base-level-line {{menuActive([url('sell/list/*')],1)}}">

                            <li class="sidebar-item {{ menuActive([url('sell/list/approval')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/approval')) }}"
                                   href="{{ route('admin.gameSellList','approval')}}">
                                    <span class="hide-menu">@lang('Approval')</span>
                                </a>
                            </li>

                            <li class="sidebar-item {{ menuActive([url('sell/list/pending')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/pending')) }}"
                                   href="{{ route('admin.gameSellList','pending')}}">
                                    <span class="hide-menu">@lang('Pending')</span>
                                </a>
                            </li>

                            <li class="sidebar-item {{ menuActive([url('sell/list/resubmission')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/resubmission')) }}"
                                   href="{{ route('admin.gameSellList','resubmission')}}">
                                    <span class="hide-menu">@lang('Resubmission')</span>
                                </a>
                            </li>

                            <li class="sidebar-item {{ menuActive([url('sell/list/hold')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/hold')) }}"
                                   href="{{ route('admin.gameSellList','hold')}}">
                                    <span class="hide-menu">@lang('Hold')</span>
                                </a>
                            </li>

                            <li class="sidebar-item {{ menuActive([url('sell/list/soft-reject')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/soft-reject')) }}"
                                   href="{{ route('admin.gameSellList','soft-reject')}}">
                                    <span class="hide-menu">@lang('Soft Rejected')</span>
                                </a>
                            </li>

                            <li class="sidebar-item {{ menuActive([url('sell/list/hard-reject')]) }}">
                                <a class="sidebar-link {{ menuActive(url('sell/list/hard-reject')) }}"
                                   href="{{ route('admin.gameSellList','hard-reject')}}">
                                    <span class="hide-menu">@lang('Hard Rejected')</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="sidebar-item {{menuActive(['admin.transaction*'],3)}}">
                    <a class="sidebar-link" href="{{ route('admin.transaction') }}" aria-expanded="false">
                        ...
                        <span class="hide-menu">@lang('Transaction Log')</span>
                    </a>
                </li>

                @if(config('basic.top_up'))
                    <li class="sidebar-item {{menuActive(['admin.topUpSell*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.topUpSell') }}" aria-expanded="false">
                            <i class="fas fa-gamepad"></i>
                            <span class="hide-menu">@lang('Topup Payment')</span>
                        </a>
                    </li>
                @endif

                @if(config('basic.voucher'))
                    <li class="sidebar-item {{menuActive(['admin.voucherSell*'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.voucherSell') }}" aria-expanded="false">
                            <i class="fas fa-tag"></i>
                            <span class="hide-menu">@lang('Voucher Payment')</span>
                        </a>
                    </li>
                @endif

                @if(config('basic.gift_card'))
                    <li class="sidebar-item {{menuActive(['admin.sellGiftCard','admin.giftCardSell.search'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.sellGiftCard') }}" aria-expanded="false">
                            <i class="fab fa-cc-apple-pay"></i>
                            <span class="hide-menu">@lang('Gift Card Payment')</span>
                        </a>
                    </li>
                @endif
                ...
                @if(config('basic.sell_post'))
                    <li class="sidebar-item {{menuActive(['admin.postSell','admin.postSell.search'],3)}}">
                        <a class="sidebar-link" href="{{ route('admin.postSell') }}" aria-expanded="false">
                            <i class="fas fa-newspaper"></i>
                            <span class="hide-menu">@lang('Sold Post')</span>
                        </a>
                    </li>
                @endif
